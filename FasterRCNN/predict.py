...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    #dir_origin_path = "E:\kg\data\sonar_val\Stylebank_FastStyle_Compare/airplane_cutoff_faststyle_output"
    dir_origin_path = "E:\kg\data\sonar_val\Stylebank_FastStyle_Compare\sametarget"
