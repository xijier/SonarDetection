...
if __name__ == "__main__":
    ...
    VOV_Annotations_Path = "E:/kg/data/VOCdevkit/VOC2007_1/Annotations/"
    VOV_JPEGImages_Path = "E:/kg/data/VOCdevkit/VOC2007_1/SegmentationObject/"
    ...
    for imageName in files_img_obj:
        ...
        imagePath = "E:/kg/data/SONAR_VOC/VOC2007_1/JPEGImages/"
        xml_path = "E:/kg/data/SONAR_VOC/VOC2007_1/Annotations/"
    ...
    # data_path = "../VOCdevkit/VOC2007/Annotations/000047.xml"
    # imageName = "000047.jpg"
    # img_obj = cv2.imread("../VOCdevkit/VOC2007/JPEGImages/"+imageName)
    # plt.imshow(imutils.opencv2matplotlib(img_obj))
    # plt.show()
    # DOMTree = xml.dom.minidom.parse(data_path)
    # data = DOMTree.documentElement
    # nodelist = data.getElementsByTagName("object")
    ...
    #
    #
    # imagePath = '../SONAR_VOC/JPEGImages/'
    # xml_path = "../SONAR_VOC/Annotations/"
    # img_xml = imageName.split(".")[0] + ".xml"
    # cv2.imwrite(imagePath+imageName, outPutImg)
    # to_xml(imagePath, imageName, xml_path, img_xml,clas)
    # plt.imshow(imutils.opencv2matplotlib(outPutImg))
    # plt.show()
