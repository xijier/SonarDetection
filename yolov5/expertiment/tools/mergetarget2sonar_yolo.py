...
if __name__ == "__main__":
    ...
    img_folder_path = "E:\kg\data\SONAR_VOC_MulitScale_styletransfer\VOC2007_Style_1/target_origin_noVOC\content_styled/"
    target_img_path = "E:\kg\data\SONAR_VOC_MulitScale_styletransfer\VOC2007_Style_1/target_origin_noVOC/JPEGImages/"
    target_xml_path = "E:\kg\data\SONAR_VOC_MulitScale_styletransfer\VOC2007_Style_1/target_origin_noVOC/Annotations/"
    JPEGImages_pool = "E:\kg\data\SONARIMG_pool/"
    lables = ['aeroplane','bicycle','car','person','ship']
    #4种缩放类别
    shrink_size_list = [(64, 64),(32, 64),(32, 32),(64, 32)]
    #产生range(5800,6000)张带有目标的声呐图片
