...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'configs/transformer/yolov5s-transformer.yaml', help='model.yaml path')
...
if __name__ == "__main__":
    ...
    main(opt)
    # b = torch.rand(3, 2)
    # a = torch.rand(8, 40,44,64)
    # c = torch.rand(8, 40, 40, 64)
    # d = c.view(8,5,8,5,8,64)
    # e = torch.reshape(c, (8,5,8,5,8,64))
    # print(b)
