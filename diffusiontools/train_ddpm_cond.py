...
from dataset.watertank_dataset import WatertankDataset
from dataset.uatd_dataset import UATDDataset
from dataset.uatd_class_dataset import UATDCLASSDataset
...
def train(args):
    ...
    im_dataset_cls = {
        ...
        'watertank': WatertankDataset,
        'uatdclass': UATDCLASSDataset,
    ...
    for epoch_idx in range(num_epochs):
        ...
        for data in tqdm(data_loader):
            ...
            # print(f"程序运行时间 1: {elapsed_time} 秒")
            #
            # start_time = time.time()
            if not im_dataset.use_latents:
                with torch.no_grad():
            ...
            # end_time = time.time()
            # elapsed_time = end_time - start_time
            # print(f"程序运行时间 2: {elapsed_time} 秒")
            ...
            if 'class' in condition_types:
                ...
                # if dataset_config['name'] =='uatdclass':
                #     labels = cond_input['class']
                # else:
                #     labels = cond_input['class']
            ...
            # end_time = time.time()
            # elapsed_time = end_time - start_time
            # print(f"程序运行时间 3: {elapsed_time} 秒")
            # start_time = time.time()
            # Sample random noise
            ...
            # end_time = time.time()
            # elapsed_time = end_time - start_time
            # print(f"程序运行时间 4: {elapsed_time} 秒")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', dest='config_path',
                        default='../config/uatd_class_cond.yaml', type=str)
